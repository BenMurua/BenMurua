      ...
      <Grid container spacing={6}>
        ...
        <Grid size={5}>
          ...
          <Item>
            ...
            <p className="exercise"> maximum pull ups (+10% weight)</p>
            <p className="rest"> 2 minutes rest</p>
            <p className="exercise"> 80% of maximum pull ups (+10% weight)</p>
            <p className="rest"> 2 minutes rest</p>
            <p className="exercise"> maximum pull ups (+10% weight)</p>
          </Item>
          ...
          <p className="exercise"> 70% of maximum pull ups</p>
            ...
            <p className="exercise"> 70% of maximum pull ups (+10% weight)</p>
            <p className="rest"> 1,5 minutes rest</p>
            <p className="exercise"> 70% of maximum pull ups (+10% weight)</p>
            <p className="rest"> 1,5 minutes rest</p>
            <p className="exercise"> maximum pull ups (+10% weight)</p>
        ...
        <FormControlLabel  control={<Checkbox/>} label="DAY 4" />
          <Item>
            <p className="exercise"> 80% of maximum pull ups</p>
            <p className="rest"> 2 minutes rest</p>
            <p className="exercise"> maximum pull ups (+20% weight)</p>
            <p className="rest"> 2 minutes rest</p>
            <p className="exercise"> 80% of maximum pull ups (+20% weight)</p>
            <p className="rest"> 2 minutes rest</p>
            <p className="exercise"> maximum pull ups (+20% weight)</p>
          </Item>
          <p className="rest"> 1 day rest</p>
